...
import thaumicinsurgence.tileentity.kekztech.TE_IchorJar;
import thaumicinsurgence.tileentity.kekztech.TE_IchorVoidJar;
...
public class BlockIchorJar extends BlockJar {
    ...
    public BlockIchorJar() {
        super();

        super.setHardness(12.0F);
        super.setResistance(3.0f);
        super.setHarvestLevel("pickaxe", 3);
        super.setBlockName("ichorJar");
