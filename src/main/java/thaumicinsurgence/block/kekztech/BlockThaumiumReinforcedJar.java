package thaumicinsurgence.block.kekztech;
...
import thaumicinsurgence.tileentity.kekztech.TE_ThaumiumReinforcedJar;
import thaumicinsurgence.tileentity.kekztech.TE_ThaumiumReinforcedVoidJar;
...
public class BlockThaumiumReinforcedJar extends BlockJar {
    ...
    public BlockThaumiumReinforcedJar() {
        super();

        super.setHardness(6.0F);
        super.setResistance(6.0F);
        super.setHarvestLevel("pickaxe", 2);
        super.setBlockName("thaumiumJar");
