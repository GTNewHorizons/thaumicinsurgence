...
public class BlockCursedArcanaSapling extends BlockSapling {
    ...
    public static String saplings[] = {
            "trypophobius", "oblivion", "old_oblivion", "tarnished", "numnum"};
    ...
    public void func_149878_d(World w, int x, int y, int z, Random rnd) {
        ...
        switch (meta){
            case 0:
                new WorldGenBigOak(true, 6, meta, meta, 5, ArcanaBlocks.blockArcanaLogDeviceOne, ArcanaBlocks.blockCursedArcanaLeafDevice).generate(w, rnd, x, y, z);
                return;
            case 1:
                new WorldGenBigOak(true, 6, meta, meta, 5, ArcanaBlocks.blockArcanaLogDeviceTwo, ArcanaBlocks.blockCursedArcanaLeafDevice).generate(w, rnd, x, y, z);
                return;
            case 2:
                new WorldGenBigOak(true, 6, meta-1, meta, 5, ArcanaBlocks.blockArcanaLogDeviceTwo, ArcanaBlocks.blockCursedArcanaLeafDevice).generate(w, rnd, x, y, z);
                return;
            case 3:
            case 4:
                new WorldGenBigOak(true, 6, meta-3, meta, 5, ArcanaBlocks.blockArcanaLogDeviceThree, ArcanaBlocks.blockCursedArcanaLeafDevice).generate(w, rnd, x, y, z);
        }
    }
