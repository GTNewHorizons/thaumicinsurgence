...
public class ItemBlockArcanaTaintedWoodDevice extends ItemBlock {

    public ItemBlockArcanaTaintedWoodDevice(Block block) {
        super(block);
        setHasSubtypes(true);
    }
    ...
    public void getSubItems(Item item, CreativeTabs tab, List list) {
        ...
        for (int i = 0; i < BlockArcanaTaintedWoodDevice.blocks.length; i++) {
