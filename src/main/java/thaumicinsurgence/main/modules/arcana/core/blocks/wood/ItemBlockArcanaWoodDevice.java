...
public class ItemBlockArcanaWoodDevice extends ItemBlock {

    public ItemBlockArcanaWoodDevice(Block block) {
        super(block);
        setHasSubtypes(true);
    }
    ...
    public void getSubItems(Item item, CreativeTabs tab, List list) {
        ...
        for (int i = 0; i < BlockArcanaWoodDevice.blocks.length; i++) {
