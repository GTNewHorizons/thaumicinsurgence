...
public class BlockAlkimiumAlchFurnace extends BlockContainer {
    ...
    public IIcon[] icons = new IIcon[6][6];
    ...
    public void registerBlockIcons(IIconRegister ir) {
        icons[0][0] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_basic_side");
        icons[0][1] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_top");
        icons[0][2] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_top");
        icons[0][3] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_basic_front");
        icons[0][4] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_basic_front_on");
        icons[0][5] = ir.registerIcon("thaumcraft:al_furnace_side");

        icons[1][0] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_thaumium_side");
        icons[1][1] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_top");
        icons[1][2] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_top_on");
        icons[1][3] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_thaumium_front");
        icons[1][4] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_thaumium_front_on");
        icons[1][5] = ir.registerIcon("planarartifice:bottom");

        icons[2][0] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_void_side");
        icons[2][1] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_top");
        icons[2][2] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_top");
        icons[2][3] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_void_front");
        icons[2][4] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_void_front_on");
        icons[2][5] = ir.registerIcon("planarartifice:bottom_void");

        icons[3][0] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_mithrillium_side");
        icons[3][1] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_top");
        icons[3][2] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_top");
        icons[3][3] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_mithrillium_front");
        icons[3][4] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_mithrillium_front_on");
        icons[3][5] = ir.registerIcon("planarartifice:mithrillium_block");

        icons[4][0] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_adaminite_side");
        icons[4][1] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_top");
        icons[4][2] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_top");
        icons[4][3] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_adaminite_front");
        icons[4][4] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_adaminite_front_on");
        icons[4][5] = ir.registerIcon("planarartifice:adaminite_block");

        icons[5][0] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_mithminite_side");
        icons[5][1] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_top");
        icons[5][2] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_top");
        icons[5][3] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_mithminite_front");
        icons[5][4] = ir.registerIcon("planarartifice:furnaces/alkimium_smeltery_mithminite_front_on");
        icons[5][5] = ir.registerIcon("planarartifice:mithminite_block");
    }
