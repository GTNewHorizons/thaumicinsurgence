...
public class ThaumcraftHelper implements IModHelper {
	...
	public static void setupCrafting() {
		...
		0,
		new AspectList().add(Aspect.MAGIC, 100).add(Aspect.HUNGER, 100).add(Aspect.TOOL, 75).add(Aspect.TRAP, 50).add(Aspect.MECHANISM, 50).add(Aspect.EXCHANGE, 25),
	...
	public static void setupResearch() {
		...
		ResearchCategories.registerCategory(category, new ResourceLocation(CommonProxy.DOMAIN, CommonProxy.ITEM_TEXTURE + "silverwood_filter.png"), new ResourceLocation("thaumcraft", "textures/gui/gui_researchback.png"));
		ResearchItem infusionInterceptorPage;
		ResearchPage interceptor1, interceptor2;
		infusionInterceptorPage = new ResearchItem("InfusionInterceptor", category, new AspectList(), 0, 0, 0, new ItemStack(Config.infusionIntercepter));
